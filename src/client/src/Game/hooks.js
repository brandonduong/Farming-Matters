...
import { initializeFarmBuildings, initializeLandscape, intializeFarmLand } from "./helpers";
import {
    SEASONS,
...
export const useEvents = () => {
    const { setAccessToConsultant, isEventHappening, setIsEventHappening, typeOfCatastrophicEvent, setTypeOfCatastrophicEvent, setDisplayTransition, setAutoPrompt } = useConsultant();
...
export const useConsultantEffects = (gameStateJustloaded, setGameStateJustloaded) => {
...
export const useInitializeGame = (initialGrid, setLoading, setLoadedTurn, setGameStateJustloaded) => {
    const { setTurn, setMoney, setSeason, setDecisionType, setLandscape, setFarmBuildings, setGrid } = useGameInfo();
