...
export const itemFluctuation = [
  {
    ...
    name: 'rice',
    price: 200,
    fluctuationFactor: 20,
  },
  {
    id: 1,
    name: 'carrot',
    price: 400,
    fluctuationFactor: 40,
  },
  {
    id: 2,
    name: 'orange',
    price: 300,
    fluctuationFactor: 25,
  },
  {
    id: 3,
    name: 'lettuce',
    price: 300,
    fluctuationFactor: 15,
  },
  {
    id: 4,
    name: 'tomato',
    price: 240,
    fluctuationFactor: 10,
  },
  {
    id: 5,
    name: 'watermelon',
...
export const seasonTransition = [
  ...
  {
    HeavyRain:
      'Oh dear it looks a severe Thunder Storm has came in overnight. Crops that are not protected will be destroyed.',
  },
  {
    Drought:
      'Oh dear it looks a severe Drought has came in overnight. Crops that are not protected will be destroyed.',
  },
  {
    Tornadoes:
      'Oh dear it looks a severe Tornado has came in overnight. Crops that are not protected will be destroyed.',
  },
];
