        ...
        <div className="purchase-consultant">
          ...
          <div className="purchase-tip">
            <button
              ...
              onClick={() => props.purchaseConsultant()}
              disabled={!props.canPurchaseConsultant()}
            >
              Purchase
            </button>
            <button className="close-button" onClick={() => props.onExit()}>
              x
            </button>
          </div>
        </div>
      ...
      <div className="dialog-grid">
        ...
        <div className="box arrow-left">
          <div className="avatar-info">
            ...
            <div className="dialog-statement">"{props.statement}"</div>
          </div>
          <button className="close-button" onClick={() => props.onExit()}>
            x
          </button>
